...
1. Download the [corresponding release](https://github.com/esphome-libs/async-mqtt-client/releases/latest)
2. Load the `.zip` with **Sketch → Include Library → Add .ZIP Library**

AsyncMqttClient has 1 dependency: [ESPAsyncTCP](https://github.com/esphome-libs/ESPAsyncTCP). Download the [.zip](https://github.com/esphome-libs/ESPAsyncTCP/archive/refs/heads/main.zip) and install it with the same method as above.
